...
Partial Class frmAboutLFTFC
    ...
    Private Sub InitializeComponent()
        ...
        lblDeveloper.Text = "LANDFIRE Interagency Program (Fuel)" & vbCrLf & "Ver. 5.1.0 ArcPro 3 Beta" & vbCrLf & "Dev: Tobin Smail USFS RMRS FMI LANDFIRE" & vbCrLf & "        Michelle Hawks FS-FSIC-Enterprise Program" & vbCrLf
        ' 
        ' lblVersion
        ' 
